...
public class EmployeesController implements Initializable {
    ...
    private void gererpublication(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/ConfirmerPub.fxml"));
            Parent root = loader.load();
            ConfirmerPubController controller =  loader.getController();
    ...
    private void gererservice(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/MainService.fxml"));
            Parent root = loader.load();
