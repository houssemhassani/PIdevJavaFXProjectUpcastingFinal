...
public class GérerProfilEmployeeController implements Initializable {
    ...
    private void gerertache(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/emp_Taches_view.fxml"));
            Parent root = loader.load();
            Emp_Taches_viewController controller =  loader.getController();
            //controller.setCin(this.cinlabel.getText());
    ...
    private void gererprofil(ActionEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Views/GérerProfilEmployee.fxml"));
            Parent root = loader.load();
            GérerProfilEmployeeController controller =  loader.getController();
            //controller.setCin(this.cinlabel.getText());
            this.gererprofil.getScene().setRoot(root);
        } catch (IOException ex) {
            System.out.println(ex.getMessage());
